...
A comprehensive tool for analyzing and comparing Defold component sizes across versions. The analyzer supports both native engine binaries and Java tooling (bob.jar) analysis with interactive visualizations.

## Overview

The Defold Size Analyzer consists of two main components:
1. **Data Collection Pipeline** - Automated analysis and CSV generation
2. **Web-based Viewer** - Interactive visualization and comparison tools
...
3. Viewer automatically detects and supports new format
4. No code changes required for new metrics or platforms